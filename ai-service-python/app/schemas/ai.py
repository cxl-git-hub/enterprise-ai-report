...
class NL2SQLRequest(BaseModel):
    ...
    dataset_ids: Optional[List[int]] = Field(None, description="Restrict to specific datasets")
...
class AnalysisRequest(BaseModel):
    ...
    dataset_ids: List[int] = Field(..., min_length=1, description="Datasets to analyze")
